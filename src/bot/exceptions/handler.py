...
class ExceptionHandler(commands.Cog):
    ...
    async def error_handler(self, ctx: disnake.ApplicationCommandInteraction | disnake.MessageCommandInteraction, error):
        ...
        embed = disnake.Embed(
            description=f'An internal error occurred, it has been reported to the developer. You can follow updates & bug fixes in the [support server](https://discord.gg/feast)',
            color=disnake.Color.red(),
        )
