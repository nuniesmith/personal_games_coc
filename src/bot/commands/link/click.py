        ...
        if ctx.data.custom_id == 'Refresh Roles':
            ...
            if player is None:
                ...
                if clan is not None:
                    ...
                    embed.set_image(url='https://feast.b-cdn.net/clash-assets/bot/find_player_tag.png')
            ...
            embed2.set_image(url='https://feast.b-cdn.net/clash-assets/bot/api_token_help.png')
