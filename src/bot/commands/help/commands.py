...
class HelpCommands(commands.Cog, name='Help'):
    ...
    @commands.slash_command(
        name='help',
        description='List of commands & descriptions for Feast',
    ...
    async def ask(self, ctx: disnake.ApplicationCommandInteraction, question: str):
        ...
        if gitbook_urls:
            ...
            # Send reply
            embed = disnake.Embed(
                description='This info is pulled from our [docs](https://docs.feast.xyz), to try to help assist you.',
