...
USE_CODE_TEXT = [
    'Roses are red, Violets are Blue, if you use Code Feast, I will love you :)',
]
...
WHITELIST_OPTIONS = ['ticket']

placeholders = [
    'https://feast.b-cdn.net/placeholders/DRC_pose03_groundShadows_5k.png',
    'https://feast.b-cdn.net/placeholders/Electrofire%20Wizard.png',
    'https://feast.b-cdn.net/placeholders/Frosty.png',
    'https://feast.b-cdn.net/placeholders/Goblin%20Champion%20July%202023.png',
    'https://feast.b-cdn.net/placeholders/PainterKing_Marketing_Shadow_B.png',
    'https://feast.b-cdn.net/placeholders/Royal%20Ghost.png',
    'https://feast.b-cdn.net/placeholders/LeagueRC_Pose04_NoShadow.png',
    'https://feast.b-cdn.net/placeholders/League%20Queen.png',
    'https://feast.b-cdn.net/placeholders/LeagueBK_Pose06_NoShadow.png',
]

DISCORD_STATUS_TYPES = {
    'Online': disnake.Status.online,
    'Offline': disnake.Status.offline,
